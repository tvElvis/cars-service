...
export class carStore1584714215134 implements MigrationInterface {
    name = 'carStore1584714215134'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "car" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "firstRegistrationDate" TIMESTAMP NOT NULL DEFAULT now(), "model" character varying(50) NOT NULL, "price" integer NOT NULL DEFAULT 0, "discount" integer NOT NULL DEFAULT 0, "manufacturerId" uuid NOT NULL, CONSTRAINT "PK_55bbdeb14e0b1d7ab417d11ee6d" PRIMARY KEY ("id"))`, undefined);

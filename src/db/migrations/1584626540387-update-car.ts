...
export class updateCar1584626540387 implements MigrationInterface {
    name = 'updateCar1584626540387'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "car" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "firstRegistrationDate" TIMESTAMP NOT NULL DEFAULT now(), "model" character varying(50) NOT NULL, "price" integer NOT NULL DEFAULT 0, "manufacturerId" uuid NOT NULL, CONSTRAINT "PK_55bbdeb14e0b1d7ab417d11ee6d" PRIMARY KEY ("id"))`, undefined);
